/* @ts-self-types="./riscv_emulator.d.ts" */
...
export class EmulatorWasm {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        EmulatorWasmFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_emulatorwasm_free(ptr, 0);
    }
    /**
     ...
     */
    is_fault() {
        const ret = wasm.emulatorwasm_is_fault(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     ...
     */
    is_halted() {
        const ret = wasm.emulatorwasm_is_halted(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     ...
     */
    is_poweroff() {
        const ret = wasm.emulatorwasm_is_poweroff(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     ...
     */
    is_restart() {
        const ret = wasm.emulatorwasm_is_restart(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     ...
     */
    constructor() {
        const ret = wasm.emulatorwasm_new();
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0];
        EmulatorWasmFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     */
    send_key(byte) {
        wasm.emulatorwasm_send_key(this.__wbg_ptr, byte);
    }
    /**
    ...
    step_batch(n) {
        ...
        let deferred1_1;
        try {
            const ret = wasm.emulatorwasm_step_batch(this.__wbg_ptr, n);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
...
if (Symbol.dispose) EmulatorWasm.prototype[Symbol.dispose] = EmulatorWasm.prototype.free;
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./riscv_emulator_bg.js": import0,
    };
}

const EmulatorWasmFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_emulatorwasm_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('riscv_emulator_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
